...
# def bbox_plotter():
#     global last_cv_image, last_bbox_image
#     while last_cv_image is None:
#         pass
#     while True:
#         with torch.no_grad():
...
# def bbox_callback(new_bbox):
#     global last_cv_image, last_bounding_box
#     new_bbox_data = []
#     for box_idx in range(0,len(new_bbox.data),6):
#         box = []
#         box.append(new_bbox.data[0 + box_idx])
#         box.append(new_bbox.data[1 + box_idx])
#         box.append(new_bbox.data[2 + box_idx])
#         box.append(new_bbox.data[3 + box_idx])
#         box.append(new_bbox.data[4 + box_idx])
#         box.append(new_bbox.data[5 + box_idx])
#         new_bbox_data.append(box)
#     last_bounding_box = new_bbox_data
